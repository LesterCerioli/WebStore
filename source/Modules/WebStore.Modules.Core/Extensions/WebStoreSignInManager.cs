...
using WebStore.Modules.Core.Events;

namespace WebStore.Modules.Core.Extensions
{
    public class WebStoreSignInManager<TUser> : SignInManager<TUser> where TUser : class
    {
        private readonly IMediator _mediator;

        public WebStoreSignInManager(UserManager<TUser> userManager,
